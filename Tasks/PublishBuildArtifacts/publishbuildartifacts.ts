    ...
    try {
        ...
        if (artifactType === "container") {
            ...
            if (os.platform() == 'win32') {
                ...
                let command: string = `& ${pathToPSString(script)} -Source ${pathToPSString(pathtoPublish)} -Target ${artifactPath}`
                let powershell: tr.ToolRunner = new tr.ToolRunner('powershell.exe');
